...
<!-- THE SEND ERROR THAT SENDS INVALID DATA IS FROM THIS AJAX SECTION / ADDITION. FIX THIS AJAX JQUERY SECTION TO CORRECT FORM VALIDATION AND SEND ISSUES. FIX SECTION BELOW. -->    
    <script>
		...
		$("#contact-form").submit(function(event) {
			...
			$.ajax({
				...
				success: function(result){
					$("#form-container").hide();
					$("#message-placeholder").show().html(result).css("margin-top","150px").css("margin-bottom","150px");
					}
				});
			});
         });
    </script>
<!-- THE SEND ERROR THAT SENDS INVALID DATA IS FROM THIS AJAX SECTION / ADDITION. FIX THIS AJAX JQUERY SECTION TO CORRECT FORM VALIDATION AND SEND ISSUES. FIX SECTION ABOVE. -->    
